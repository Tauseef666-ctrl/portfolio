...
export const languages: Language[] = [
  ...
  {
    name: "Python",
    note: "AI voice assistant with Luna, cyber tooling and scripting experiments.",
    accent: "#34d399",
    usage: ["AI", "Automation", "CLI"],
  },
  {
    name: "Shell",
    note: "Bash terminal automation and tooling scripts.",
    accent: "#a3e635",
    usage: ["Tooling", "Automation"],
  },
  {
    name: "React",
    note: "UI library behind nearly every web app and platform I ship.",
    accent: "#22d3ee",
    usage: ["Web apps", "SPAs"],
  },
  {
    name: "Next.js",
    note: "Framework powering B.Sc Companion, CAT PREP and 2nd Year Lateral.",
    accent: "#94a3b8",
    usage: ["Web apps", "SSR"],
  },
  {
    name: "Vite",
    note: "Fast build tool for my React and TypeScript projects.",
    accent: "#8b5cf6",
    usage: ["Build", "Tooling"],
  },
  {
    name: "Tailwind CSS",
    note: "Utility-first styling used across my modern frontends.",
    accent: "#818cf8",
    usage: ["Styling", "UI"],
  },
  {
    name: "Three.js",
    note: "3D graphics powering this portfolio and Space Research Platform.",
    accent: "#a78bfa",
    usage: ["3D", "WebGL"],
  },
  {
    name: "React Three Fiber",
    note: "React renderer for building Three.js scenes declaratively.",
    accent: "#c084fc",
    usage: ["3D", "React"],
  },
  {
    name: "Tauri",
    note: "Desktop shell for the Luna AI voice assistant on Windows.",
    accent: "#f9a8d4",
    usage: ["Desktop", "AI"],
  },
  {
    name: "Node.js",
    note: "JavaScript runtime for tooling, servers and automation.",
    accent: "#4ade80",
    usage: ["Runtime", "Tooling"],
  },
  {
    name: "React Native",
    note: "Cross-platform mobile framework for T2S Study Together.",
    accent: "#38bdf8",
    usage: ["Mobile", "Apps"],
  },
  {
    name: "Expo",
    note: "Mobile development workflow for React Native builds.",
    accent: "#64748b",
    usage: ["Mobile", "Apps"],
  },
  {
    name: "Pyodide",
    note: "Runs Python in the browser — powers Python Learn App.",
    accent: "#fbbf24",
    usage: ["Python in browser", "Learning"],
  },
  {
    name: "Capacitor",
    note: "Wraps web apps into native Android/iOS — used in Noorul Quran.",
    accent: "#2dd4bf",
    usage: ["Mobile", "Native wrapper"],
  },
  {
    name: "Android Studio",
    note: "My Android development environment for Evolve, RopeTyper and CyberSec Hub.",
    accent: "#16a34a",
    usage: ["Android", "IDE"],
  },
  {
    name: "Framer Motion",
    note: "Animations and transitions in this portfolio.",
    accent: "#ec4899",
    usage: ["Animation", "React"],
  },
  {
    name: "MediaPipe",
    note: "Real-time webcam hand tracking in Ninja Slice.",
    accent: "#06b6d4",
    usage: ["Computer vision", "Web"],
  },
  {
    name: "Ollama",
    note: "Local LLM runtime behind Luna AI's offline voice assistant.",
    accent: "#ef4444",
    usage: ["AI", "Local LLM"],
  },
  {
    name: "Git",
    note: "Version control for all my projects.",
    accent: "#fb923c",
    usage: ["Version control"],
  },
  {
    name: "GitHub",
    note: "Hosting, collaboration and deployment for my open-source work.",
    accent: "#e2e8f0",
    usage: ["Hosting", "CI/CD"],
  },
  {
    name: "Vercel",
    note: "Deployment platform for most of my live web apps.",
    accent: "#22c55e",
    usage: ["Deploy", "Hosting"],
  },
  {
    name: "Netlify",
    note: "Hosting for my browser experiments and games.",
    accent: "#f97316",
    usage: ["Deploy", "Hosting"],
  },
];
